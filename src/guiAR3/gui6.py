...
class Ui_GUI_FMA(object):
    ...
    def setupUi(self, GUI_FMA):
        ...
        GUI_FMA.resize(671, 654)
        GUI_FMA.setStyleSheet("")
        self.pushButton = QtWidgets.QPushButton(GUI_FMA)
        self.pushButton.setGeometry(QtCore.QRect(380, 90, 131, 41))
        self.pushButton.setObjectName("pushButton")
        self.pushButton_2 = QtWidgets.QPushButton(GUI_FMA)
        self.pushButton_2.setGeometry(QtCore.QRect(380, 140, 131, 41))
        self.pushButton_2.setObjectName("pushButton_2")
        self.pushButton_3 = QtWidgets.QPushButton(GUI_FMA)
        self.pushButton_3.setGeometry(QtCore.QRect(510, 520, 71, 31))
        self.pushButton_3.setObjectName("pushButton_3")
        self.label = QtWidgets.QLabel(GUI_FMA)
        self.label.setGeometry(QtCore.QRect(380, 240, 21, 20))
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(GUI_FMA)
        self.label_2.setGeometry(QtCore.QRect(380, 280, 21, 20))
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(GUI_FMA)
        self.label_3.setGeometry(QtCore.QRect(380, 320, 21, 20))
        self.label_3.setObjectName("label_3")
        self.label_4 = QtWidgets.QLabel(GUI_FMA)
        self.label_4.setGeometry(QtCore.QRect(380, 360, 21, 20))
        self.label_4.setObjectName("label_4")
        self.label_5 = QtWidgets.QLabel(GUI_FMA)
        self.label_5.setGeometry(QtCore.QRect(380, 400, 21, 20))
        self.label_5.setObjectName("label_5")
        self.label_6 = QtWidgets.QLabel(GUI_FMA)
        self.label_6.setGeometry(QtCore.QRect(380, 440, 21, 20))
        self.label_6.setObjectName("label_6")
        self.label_7 = QtWidgets.QLabel(GUI_FMA)
        self.label_7.setGeometry(QtCore.QRect(380, 480, 21, 20))
        self.label_7.setObjectName("label_7")
        self.pushButton_4 = QtWidgets.QPushButton(GUI_FMA)
        self.pushButton_4.setGeometry(QtCore.QRect(520, 90, 131, 41))
        self.pushButton_4.setObjectName("pushButton_4")
        self.pushButton_5 = QtWidgets.QPushButton(GUI_FMA)
        self.pushButton_5.setGeometry(QtCore.QRect(420, 520, 81, 31))
        self.pushButton_5.setObjectName("pushButton_5")
        self.lineEdit = QtWidgets.QLineEdit(GUI_FMA)
        self.lineEdit.setGeometry(QtCore.QRect(570, 240, 61, 25))
        self.lineEdit.setObjectName("lineEdit")
        self.lineEdit_2 = QtWidgets.QLineEdit(GUI_FMA)
        self.lineEdit_2.setGeometry(QtCore.QRect(570, 280, 61, 25))
        self.lineEdit_2.setObjectName("lineEdit_2")
        self.lineEdit_3 = QtWidgets.QLineEdit(GUI_FMA)
        self.lineEdit_3.setGeometry(QtCore.QRect(570, 320, 61, 25))
        self.lineEdit_3.setObjectName("lineEdit_3")
        self.lineEdit_6 = QtWidgets.QLineEdit(GUI_FMA)
        self.lineEdit_6.setGeometry(QtCore.QRect(570, 480, 61, 25))
        self.lineEdit_6.setObjectName("lineEdit_6")
        self.lineEdit_7 = QtWidgets.QLineEdit(GUI_FMA)
        self.lineEdit_7.setGeometry(QtCore.QRect(570, 440, 61, 25))
        self.lineEdit_7.setObjectName("lineEdit_7")
        self.lineEdit_8 = QtWidgets.QLineEdit(GUI_FMA)
        self.lineEdit_8.setGeometry(QtCore.QRect(570, 360, 61, 25))
        self.lineEdit_8.setObjectName("lineEdit_8")
        self.lineEdit_9 = QtWidgets.QLineEdit(GUI_FMA)
        self.lineEdit_9.setGeometry(QtCore.QRect(570, 400, 61, 25))
        self.lineEdit_9.setObjectName("lineEdit_9")
        self.horizontalSlider = QtWidgets.QSlider(GUI_FMA)
        self.horizontalSlider.setGeometry(QtCore.QRect(400, 240, 160, 16))
        ...
        self.horizontalSlider_2.setGeometry(QtCore.QRect(400, 280, 160, 16))
        ...
        self.horizontalSlider_3.setGeometry(QtCore.QRect(400, 320, 160, 16))
        self.horizontalSlider_3.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider_3.setObjectName("horizontalSlider_3")
        self.horizontalSlider_3.setMinimum(0)
        self.horizontalSlider_3.setMaximum(144)
        self.horizontalSlider_4 = QtWidgets.QSlider(GUI_FMA)
        self.horizontalSlider_4.setGeometry(QtCore.QRect(400, 360, 160, 16))
        ...
        self.horizontalSlider_5.setGeometry(QtCore.QRect(400, 400, 160, 16))
        ...
        self.horizontalSlider_6.setGeometry(QtCore.QRect(400, 480, 160, 16))
        ...
        self.horizontalSlider_7.setGeometry(QtCore.QRect(400, 440, 160, 16))
...
"")
        ...
        self.label_9.setGeometry(QtCore.QRect(380, 200, 221, 17))
        ...
        self.pushButton_8.setGeometry(QtCore.QRect(70, 530, 101, 31))
        self.pushButton_8.setObjectName("pushButton_8")
        self.pushButton_9 = QtWidgets.QPushButton(GUI_FMA)
        self.pushButton_9.setGeometry(QtCore.QRect(180, 530, 101, 31))
        self.pushButton_9.setObjectName("pushButton_9")
        self.pushButton_10 = QtWidgets.QPushButton(GUI_FMA)
        self.pushButton_10.setGeometry(QtCore.QRect(180, 570, 101, 31))
        self.pushButton_10.setObjectName("pushButton_10")
        self.pushButton_11 = QtWidgets.QPushButton(GUI_FMA)
        self.pushButton_11.setGeometry(QtCore.QRect(70, 570, 101, 31))
        self.pushButton_11.setObjectName("pushButton_11")
        self.pushButton_12 = QtWidgets.QPushButton(GUI_FMA)
        self.pushButton_12.setGeometry(QtCore.QRect(70, 610, 101, 31))
        self.pushButton_12.setObjectName("pushButton_12")
        self.pushButton_13 = QtWidgets.QPushButton(GUI_FMA)
        self.pushButton_13.setGeometry(QtCore.QRect(180, 610, 101, 31))
        self.pushButton_13.setObjectName("pushButton_13")
        self.pushButton_14 = QtWidgets.QPushButton(GUI_FMA)
        self.pushButton_14.setGeometry(QtCore.QRect(220, 370, 41, 31))
        self.pushButton_14.setObjectName("pushButton_14")
        self.pushButton_16 = QtWidgets.QPushButton(GUI_FMA)
        self.pushButton_16.setGeometry(QtCore.QRect(270, 370, 41, 31))
        self.pushButton_16.setObjectName("pushButton_16")
        self.label_11 = QtWidgets.QLabel(GUI_FMA)
        self.label_11.setGeometry(QtCore.QRect(40, 380, 141, 17))
        self.label_11.setObjectName("label_11")
        self.label_12 = QtWidgets.QLabel(GUI_FMA)
        self.label_12.setGeometry(QtCore.QRect(100, 500, 171, 17))
        self.label_12.setStyleSheet("gridline-color: rgb(0, 255, 0);")
        self.label_12.setObjectName("label_12")
        self.label_13 = QtWidgets.QLabel(GUI_FMA)
        self.label_13.setGeometry(QtCore.QRect(20, 60, 171, 17))
        self.label_13.setObjectName("label_13")
        self.label_14 = QtWidgets.QLabel(GUI_FMA)
        self.label_14.setGeometry(QtCore.QRect(380, 600, 141, 21))
        self.label_14.setObjectName("label_14")
        self.lineEdit_4 = QtWidgets.QLineEdit(GUI_FMA)
        self.lineEdit_4.setGeometry(QtCore.QRect(530, 600, 121, 21))
        self.lineEdit_4.setObjectName("lineEdit_4")
        self.label_15 = QtWidgets.QLabel(GUI_FMA)
        self.label_15.setGeometry(QtCore.QRect(380, 570, 131, 17))
        self.label_15.setObjectName("label_15")
        self.lineEdit_5 = QtWidgets.QLineEdit(GUI_FMA)
        self.lineEdit_5.setGeometry(QtCore.QRect(530, 570, 121, 21))
        self.lineEdit_5.setObjectName("lineEdit_5")
        self.label_16 = QtWidgets.QLabel(GUI_FMA)
        self.label_16.setGeometry(QtCore.QRect(40, 420, 141, 17))
        self.label_16.setObjectName("label_16")
        self.pushButton_17 = QtWidgets.QPushButton(GUI_FMA)
        self.pushButton_17.setGeometry(QtCore.QRect(270, 410, 41, 31))
        self.pushButton_17.setObjectName("pushButton_17")
        self.pushButton_15 = QtWidgets.QPushButton(GUI_FMA)
        self.pushButton_15.setGeometry(QtCore.QRect(220, 410, 41, 31))
        self.pushButton_15.setObjectName("pushButton_15")
        self.label_17 = QtWidgets.QLabel(GUI_FMA)
        self.label_17.setGeometry(QtCore.QRect(40, 460, 161, 17))
        self.label_17.setObjectName("label_17")
        self.pushButton_18 = QtWidgets.QPushButton(GUI_FMA)
        self.pushButton_18.setGeometry(QtCore.QRect(220, 450, 91, 31))
        self.pushButton_18.setStyleSheet("")
        self.pushButton_18.setObjectName("pushButton_18")
        self.label_18 = QtWidgets.QLabel(GUI_FMA)
        self.label_18.setGeometry(QtCore.QRect(380, 60, 221, 17))
        self.label_18.setStyleSheet("")
        self.label_18.setObjectName("label_18")
        self.pushButton_6 = QtWidgets.QPushButton(GUI_FMA)
        self.pushButton_6.setGeometry(QtCore.QRect(520, 140, 131, 41))
    ...
    def retranslateUi(self, GUI_FMA):
        ...
        self.label_11.setText(_translate("GUI_FMA", " Control de Camara :"))
        self.label_12.setText(_translate("GUI_FMA", "Control de trayectorias:"))
        self.label_13.setText(_translate("GUI_FMA", "Visualizador de Camara: "))
        self.label_14.setText(_translate("GUI_FMA", "Modo de operacion:"))
        self.label_15.setText(_translate("GUI_FMA", "Estado de  Camara:"))
        ...
        self.label_17.setText(_translate("GUI_FMA", " Control de fotografia:"))
        self.pushButton_18.setText(_translate("GUI_FMA", "Capturar"))
        self.label_18.setText(_translate("GUI_FMA", "Modos de operacion:"))
    ...
    def state_x(self,data):
        ...
        if self.xbox_status==3:
            ...
            if self.xpi < -15 and self.xpi>-50:
                self.M6 +=0.01*64.35 #RAD
                self.plano()

            if self.xpi < -50:
                self.M6 +=0.04*64.35 #RAD
                self.plano()
    ...
    def state_y(self,data): 
        ...
        if self.xbox_status==3:
            ...
            if self.ypi < -20 and self.ypi>-100: #and M3 != 2 and M2<=1.4:
                self.M5+=0.01*57.78#RAD
                self.plano()
            if self.ypi < -100: #and M3 != 2 and M2<=1.4:
                self.M5 +=0.03*57.78  #RAD
                self.plano()
            #if M3==2:
            #	while M3 >= 0.5 and ypi < -20 and M2 <= 1.4 : 
            #		M2 +=0.02 #RAD
