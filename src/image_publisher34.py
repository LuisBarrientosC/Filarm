...
def talker2():
    ...
    if x_medium>=0 and x_medium<=640 and  y_medium>=0 and y_medium<480:
        ...
        if i==30 and xp>-20 and xp<=0 and yp>-20 and yp<=0 or  i==30 and xp>=0 and xp<20 and yp>=0 and yp<20:
            i=0
    

        if i==30 and xp<=-20 or i==30 and xp>=20 or i==30 and yp<=-20  or i==30 and yp>=20:
            i=0
