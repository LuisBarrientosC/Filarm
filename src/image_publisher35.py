...
def talker2():
    ...
    pub = rospy.Publisher('position_state_x_y' , Float32MultiArray, queue_size = 1)
    global x,i,p_x,S,y, alpha, xp,xpt,stop,T,yp
    ...
    if x_medium>=0 and x_medium<=640 and  y_medium>=0 and y_medium<480:
        ...
        if   i==20 and xp>-20 and xp<=0 and yp>-20 and yp<=0 or i==20 and xp>=0 and xp<20 and yp>=0 and yp<20:
            i=0
    

        if i==20 and xp<=-20 or i==20 and xp>=20 or i==20 and yp<=-20 or i==20 and yp>=20:
